...
class Suggestion(models.Model):
    ...
    owner = models.ForeignKey(
        Member, verbose_name="Nome de usuário", on_delete=models.CASCADE, null=False
    )
    category = models.CharField(
        verbose_name="Categoria", choices=choices.CATEGORIES, max_length=64, null=False
    )
...
class Review(models.Model):
    goal = models.CharField(verbose_name="Observações", max_length=256, null=False)
